...
public interface AgentEngineBridge {
    ...
    String generate(String runId, String projectId, String conversationId,  List<ConversationHistoryMessage> historyMessages, String message, Consumer<ToolResult> toolResultConsumer, AgentRagEventListener ragEventListener);
